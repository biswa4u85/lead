...
export default
    {
        ...
        step2: "Étape 2",
        step3: "Étape 3 ",
        step1_txt: "Décrivez votre projet en quelques étapes simples : Rien de plus simple, laissez-vous guider par notre parcours simplifié.",
        step2_txt: "Découvrez des artisans compétents pour votre projet : Nous vous proposons les meilleurs profils de votre région, sans frais ni engagement.",
        step3_txt: "Recevez plusieurs devis et choisissez votre artisan : Nous transmettons votre demande à 4 artisans en fonction de leur disponibilité.",
        finding_txt: "Trouver le bon artisan",
        has_never: "Rien de plus facile Avec Travaux Renove, simplifiez votre recherche d'artisans pour des projets de qualité.",
        expert: "Experts",
        ...
        start: "Accédez aux services",
        copy_write: "© 2024 PRO POS. Tous droits réservés",

        // Batimeent
        describe: "Décrivez-nous votre projet",
        complete_details: "Complétez vos coordonnées",
        thank_proposal: "Votre demande à bien été prise en compte !",
        confirmation_email: "Un courriel de confirmation vous sera envoyé. Nous examinerons votre proposition et vous contacterons dans les prochains jours.",
        title_label: "Title",
        ...
        city_label: "Ville",
        city_placeholder: "Saisissez la ville",
        email_label: "E-mail",
        email_placeholder: "Saisissez votre adresse mail",
        phone_label: "Numéro Téléphone",
        phone_placeholder: "Saisissez votre numéro",
        ...
        need_label: "De quoi avez-vous besoin ?",
        need_placeholder: "Précision sur votre dépannage",
        ...
        productivity: "Trouvez de nouveaux clients en toute simplicité avec ",
        services: "Dépannage Travaux",
        need_request: "Vos besoins ?",
        ...
        stripe: "Stripe",
        cards_details: "Renseigner les informations de votre carte",
        pay: "Payer",
        profeional_details: "Informations entreprise",
        name: "Nom",
        company: "Entreprise",
        ...
        client_details: "Coordonnés du client",
        Professional_text: "Professionnel",
        ...
        uplode: "Télécharger la signature",
        job: "Votre travail",
        ...
        sign_up: "Vous vous êtes inscrit avec succès. Nous vous contacterons très prochainement !",

        // success

        payment_sucessful: "Paiement effectué avec succès",
        payment_id: "Payment ID",
        amount: "Montant à payé",
        Category: "Catégorie Dépannage",
        ...
        carry_out: "Sélectionnez le type de travail que vous souhaitez effectuer",
        posted: "Affiché",
        assigned: "Attribué",
        active: "Actif",
        pending: "En attente",
        ...
        wallet: "Portefeuille",
        change_contact: "Modifier mes coordonnées",
        company_details: "Informations sur mon entreprise",
        company_paragraph: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
        information: "Mes coordonnées",
        ...
        last_placeholder: "Saisir le nom",
        ...
        assurance: "Assurance",
        guarantee: "Garantie de 10 ans",
        quality: "MES LABELS DE QUALITÉ",

        // proposal

        contract_placeholder: "Saisir la date de début du contrat",
        contractend_placeholder: "Saisir la date de fin du contrat",
        actions: "Actions",
