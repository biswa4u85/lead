      ...
      <div className="relative">
        ...
        <div className={`absolute w-full top-0 bg-black opacity-80 lg:hidden p-4 text-white ${isMobileMenuOpen ? '' : 'hidden'}`}>
          ...
          <nav className="flex flex-col" >
            <Link href={"/approval"} className="mx-2 my-1 text-white hover:text-blue-700">Find Projects</Link>
        ...
        <div className="container flex justify-between px-10 mx-auto">
          ...
          <div className='flex'>
            <nav className="flex items-center justify-between" >
              <Link href={"/approval"} className="mx-5 text-indigo-900 hover:text-blue-700">Find Projects</Link>
            </nav>
