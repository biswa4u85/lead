...
export default function Page({ params }: { params: { id: string } }) {
    ...
    const handleUpdate = () => {
        router.push(`/pro/invoice/${lead.id}`)
    }
            ...
            <div className="container p-10 mx-auto mb-10 md:mb-10">
                ...
                <div className="grid md:grid-cols-3 gap-9">
                    ...
                    <div className="col-span-1">
                        ...
                        <Buttons className="w-full p-2 my-5 text-sm font-normal text-white bg-indigo-800 rounded-md font-poppins" value="View invoice" onClick={() => handleUpdate()} />
                    </div>
                </div>
            </div>
        </>
