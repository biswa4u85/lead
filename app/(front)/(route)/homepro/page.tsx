        ...
        <>
            ...
            <div className="bg-custom-blue">
                <div className="container flex flex-col mx-auto md:flex-row md:justify-between md:items-center">
                    <div className="flex-none w-1/2">
                        <p className="py-5 font-medium leading-tight text-black whitespace-pre-wrap md:text-6xl">Increase your business productivity and performance with our <span className="font-bold text-indigo-800 border-b" >services</span>
                        </p>
            ...
            <div className="container mx-auto">
                <div className="my-10">
                    ...
                    <div className="flex flex-col items-start center md:flex-row md:justify-center ">
                        <div className="py-8 px-4 shadow-custom text-center w-80 h-full rounded-[16px] flex flex-col items-center justify-center">
                            ...
                            <ul className="text-sm list-disc text-gray">
            ...
            <div className="flex items-center justify-center w-full text-center" style={{
                ...
                <div className="container mx-auto">
                    <div className="py-10">
                        ...
                        <p className="py-5 font-semibold text-center whitespace-normal text-title-sm text-black-light md:whitespace-normal md:text-title-sm">The advantages of going through Travaux Renove to find construction sites</p>
                        <p className="text-sm text-center whitespace-normal text-black-light md:whitespace-normal">When you are a craftsman looking for new projects, Travaux Renove is there to simplify your process. Our platform offers an effective solution for quickly finding construction sites from individuals, with craftsman profiles that reflect the quality of their services, certified by customer reviews published on Travaux Renove. Thanks to accurate and verified information, your profile will present the best image of your company to individuals looking for reliable and competent professionals</p>
                        <p className="py-5 text-center whitespace-normal text-title-sm text-black-light md:whitespace-normal md:text-title-sm">The advantages of going through Travaux Renove to find construction sites</p>
                    </div>
                </div>
